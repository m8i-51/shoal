...
CI (`.github/workflows/ci.yml`) runs the type check, the test suite, and the web
build on every pull request, so running these locally first saves a round trip.
